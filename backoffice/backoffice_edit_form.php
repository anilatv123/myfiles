...
$mform->addGroup($buttonarray, 'buttonar', '', array(' '), false);
		//$this->add_action_buttons(true, get_string('yes', 'block_backoffice'));
		//$this->add_action_buttons(false, get_string('no', 'block_backoffice'));
       }
...
class backoffice_result_form extends moodleform {
    ...
    public function definition() {
		...
		//$rform->addElement('html', html_writer::tag('p', get_string('form2', 'block_backoffice')));
